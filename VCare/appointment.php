...
if(isset($_POST['entry_submit'])){
  ...
  $income=$_POST['income'];
  $query="insert into appointmenttb(fname,lname,age,contact,cancer,cancer_stage,sex,location) values ('$fname','$lname','$age','$contact','$cancer','$cancer_stage,'$sex','$location','$income');";
